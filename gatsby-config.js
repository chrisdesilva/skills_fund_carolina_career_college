module.exports = {
  siteMetadata: {
    ...
    headline: `Partner financing page for Skills Fund and Carolina Career College`,
    author: `@Skills_Fund`,
    siteLanguage: `en`,
    logo: `src/images/skillsFund_logo.png`,
    favicon: `src/images/Favicon-SF.png`,
    keywords: `skills training, coding loans, bootcamp loans, tuition loan, tuition financing, coding, web development, UX design, UI design coding bootcamp, bootcamp, full-time, part-time, student financing, student loans, loans, cosigner, underwriting, credit, credit score`
  },
  plugins: [
